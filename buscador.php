        ...
        <dl id="narrow-by-list">
                ...
                <fieldset>
                  ...
                  <div>
                   ...
                   <input type="text" name="anu_model" id="anu_model" value="">
                  </div> 
                  ...
                  <label for="color">Color bicicleta: </label>
                    ...
                    <select name="orden" id="orden" >
                      ...
                      <OPTION VALUE="`anu_model`">Modelo</OPTION>
              ...
              <form id="anadir" name="anadir" method="GET" action="insertar_datos.html">
              <input type="submit" name="anadir" value="Añade tu anuncio" />
              </form>
        </dl>    
        </div>
    </div>
    ...
    <div class="nueva_clase">
       ...
       //if ($anu_marca == "")AND($anu_modelo =="")AND($anu_ubicacio_robatori == "")AND($anu_color == "0")AND($anu_data_anunci == "")AND($anu_data_robatori == "")
        ...
        if($anu_model !=""){
            ...
            $sql .= " AND `anu_model` LIKE '%$anu_model%'  ";
        }
        if($anu_ubicacio_robatori != ""){

            $sql .= " AND  `anu_ubicacio_robatori` LIKE '%$anu_ubicacio_robatori%'  ";

        }
        
         if($anu_color !="0"){

             $sql .= " AND `anu_color` LIKE '$anu_color'  ";
        }

        if ($anu_data_anunci != ""){
             $sql .= " AND `anu_data_anunci` = '$anu_data_anunci' ";
        }

         if ($anu_data_robatori != ""){
             $sql .= " AND `anu_data_robatori` = '$anu_data_robatori' ";
        }
